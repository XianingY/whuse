...
const OSCOMP_SUITE_SCRIPT_REAL_FULL_TEMPLATE: &str = concat!(
    ...
    "    echo whuse-oscomp-watchdog:post-spawn:backend=fallback-foreground:cmd=$cmd_name:pid=fg\n",
    "    echo whuse-oscomp-watchdog:pre-wait:backend=fallback-foreground:cmd=$cmd_name:pid=fg\n",
    "    \"$cmd_name\" \"$@\"\n",
    "    rc=$?\n",
    ...
    "    if /musl/busybox --list 2>/dev/null | /musl/busybox grep -qx timeout; then\n",
    "        if /musl/busybox timeout 1 /musl/busybox true >/dev/null 2>&1; then\n",
    "            echo whuse-oscomp-watchdog:backend-select:cmd=$cmd_name:mode=busybox-timeout\n",
    "            run_with_timeout_timeout_applet \"$timeout_s\" \"$@\"\n",
    "            return \"$?\"\n",
    "        fi\n",
    "        echo whuse-oscomp-watchdog:backend-select:cmd=$cmd_name:mode=busybox-timeout-probe-failed\n",
    "    fi\n",
    ...
    "    WHUSE_IOZONE_TIMEOUT_HIT=0\n",
    "    echo \"#### OS COMP TEST GROUP START iozone ####\"\n",
    "    case \"$WHUSE_STAGE2_IOZONE_PROFILE\" in\n",
    "    full)\n",
    "        case \"$WHUSE_STAGE2_IOZONE_FULL_SCOPE\" in\n",
    "        probe)\n",
    "            iozone_case_run auto-1k-4m 100 ./iozone -a -r 1k -s 4m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-write-read 100 ./iozone -t 4 -i 0 -i 1 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            ;;\n",
    "        *)\n",
    "            iozone_case_run auto-1k-4m 100 ./iozone -a -r 1k -s 4m\n",
    ...
    "            iozone_case_run throughput-write-read 100 ./iozone -t 4 -i 0 -i 1 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-random-read 100 ./iozone -t 4 -i 0 -i 2 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-read-backwards 100 ./iozone -t 4 -i 0 -i 3 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-stride-read 100 ./iozone -t 4 -i 0 -i 5 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-fwrite-fread 100 ./iozone -t 4 -i 6 -i 7 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-pwrite-pread 100 ./iozone -t 4 -i 9 -i 10 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            iozone_case_run throughput-pwritev-preadv 100 ./iozone -t 4 -i 11 -i 12 -r 1k -s 1m\n",
    "            iozone_record_rc \"$?\"\n",
    "            ;;\n",
    "        esac\n",
    "        ;;\n",
    "    *)\n",
    "        WHUSE_IOZONE_STEP_RC=124\n",
    "        iozone_case_run smoke-write-read 60 ./iozone -i 0 -i 1 -r 4k -s 256k\n",
    "        iozone_case_run smoke-random-read 60 ./iozone -i 2 -r 4k -s 256k\n",
    "        iozone_case_run smoke-fwrite-fread 60 ./iozone -i 6 -i 7 -r 4k -s 256k\n",
    "        ;;\n",
    "    esac\n",
    "    echo \"#### OS COMP TEST GROUP END iozone ####\"\n",
    "    case \"$WHUSE_IOZONE_TIMEOUT_HIT\" in\n",
    "    1)\n",
    "        echo whuse-oscomp-step-timeout:iozone_testcode.sh:100:pid=0:tgid=0\n",
    "        ;;\n",
    "    esac\n",
    ...
    "echo whuse-oscomp-busybox-inline:before-inline-start\n",
    "/musl/busybox echo \"#### OS COMP TEST GROUP START busybox-musl ####\"\n",
    "echo whuse-oscomp-busybox-inline:after-inline-start\n",
    "busybox_fail=0\n",
    "echo whuse-oscomp-busybox-inline:cmd:true:start\n",
    "/musl/busybox true\n",
    "rc=$?\n",
    "echo whuse-oscomp-busybox-inline:cmd:true:end:$rc\n",
    "busybox_fail=$((busybox_fail + rc))\n",
    "echo whuse-oscomp-busybox-inline:cmd:uname:start\n",
    "/musl/busybox uname\n",
    "rc=$?\n",
    "echo whuse-oscomp-busybox-inline:cmd:uname:end:$rc\n",
    "busybox_fail=$((busybox_fail + rc))\n",
    "echo whuse-oscomp-busybox-inline:cmd:pwd:start\n",
    "/musl/busybox pwd\n",
    "rc=$?\n",
    "echo whuse-oscomp-busybox-inline:cmd:pwd:end:$rc\n",
    "busybox_fail=$((busybox_fail + rc))\n",
    "/musl/busybox echo \"#### OS COMP TEST GROUP END busybox-musl ####\"\n",
    "echo whuse-oscomp-step-end:busybox_testcode.sh:$busybox_fail\n",
