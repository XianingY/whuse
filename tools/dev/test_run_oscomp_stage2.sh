...
assert_contains "${REPO_ROOT}/crates/kernel-core/src/lib_loongarch.inc.rs" "loongarch-libctest-not-scored"
assert_contains "${REPO_ROOT}/crates/kernel-core/src/lib_loongarch.inc.rs" "loongarch-iozone-not-scored"
assert_contains "${REPO_ROOT}/crates/kernel-core/src/lib_loongarch.inc.rs" "loongarch-ltp-not-scored"
...
assert_order_in_array_block "${RUNNER}" "full_root_steps" "iozone_testcode.sh" "ltp_testcode.sh"
assert_order_in_array_block "${RUNNER}" "full_root_steps" "ltp_testcode.sh" "libctest_testcode.sh"
