use crate::{
    ...
    SYS_FTRUNCATE, SYS_GETCWD, SYS_GETDENTS64, SYS_IOCTL, SYS_LINKAT, SYS_LSEEK, SYS_MKDIR,
    SYS_MKNODAT, SYS_MOUNT, SYS_OPENAT, SYS_PREAD64, SYS_PREADV, SYS_PREADV2, SYS_PWRITE64,
    SYS_PWRITEV, SYS_PWRITEV2, SYS_READ, SYS_READLINKAT, SYS_READV, SYS_RENAMEAT, SYS_RENAMEAT2,
...
pub(crate) fn dispatch(
    ...
    Some(match sysno {
        ...
        SYS_FCHOWN => ctx.dispatcher.sys_fchown(args, ctx.procs, ctx.vfs),
        SYS_FGETXATTR => ctx.dispatcher.sys_fgetxattr(args, ctx.procs),
