...
pub fn ata_id_has_lba(id: &[u16]) -> bool {
    (id[ATA_ID_CAPABILITY as usize] & (1 << 9)) != 0
}

pub fn ata_id_queue_depth(id: &[u16]) -> u32 {
    (id[ATA_ID_QUEUE_DEPTH as usize] & (0x1f + 1)) as u32
}

pub fn ata_id_u32(id: &[u16], n: u32) -> u32 {
    (id[(n + 1) as usize] as u32) << 16 | (id[n as usize] as u32)
}
...
pub fn ata_id_has_flush(id: &[u16]) -> bool {
    ...
    (id[ATA_ID_COMMAND_SET_2 as usize] & (1 << 12)) != 0
}
...
pub fn ata_id_has_flush_ext(id: &[u16]) -> bool {
    ...
    (id[ATA_ID_COMMAND_SET_2 as usize] & (1 << 13)) != 0
}
...
pub fn ata_id_has_lba48(id: &[u16]) -> bool {
    ...
    (id[ATA_ID_COMMAND_SET_2 as usize] & (1 << 10)) != 0
}
...
pub fn ata_id_has_wcache(id: &[u16]) -> bool {
    ...
    (id[ATA_ID_COMMAND_SET_1 as usize] & (1 << 5)) != 0
}
...
pub fn ata_id_wcache_enabled(id: &[u16]) -> bool {
    ...
    (id[ATA_ID_CFS_ENABLE_1 as usize] & (1 << 5)) != 0
}
...
pub fn ata_id_c_string(id: &[u16], s: &mut [u8], ofs: usize) {
    ...
    let len_id: usize = len.div_ceil(2);
