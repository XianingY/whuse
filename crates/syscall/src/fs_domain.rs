use crate::{
    DispatchContext, SyscallArgs, SYS_CHDIR, SYS_CHROOT, SYS_CLOSE, SYS_CLOSE_RANGE, SYS_COPY_FILE_RANGE,
    SYS_DUP, SYS_DUP2, SYS_FACCESSAT, SYS_FACCESSAT2, SYS_FALLOCATE, SYS_FCHDIR,
    SYS_FCHMOD, SYS_FCHMODAT, SYS_FCHMODAT2, SYS_FCHOWN, SYS_FCHOWNAT, SYS_FCNTL, SYS_FDATASYNC,
    SYS_FLOCK, SYS_FSTAT, SYS_FSTATAT, SYS_FSTATFS, SYS_FSYNC, SYS_FTRUNCATE, SYS_GETCWD,
    SYS_GETDENTS64, SYS_IOCTL, SYS_LINKAT, SYS_LSEEK, SYS_MKDIR, SYS_MOUNT, SYS_OPENAT,
    SYS_PREAD64, SYS_PREADV, SYS_PREADV2, SYS_PWRITE64, SYS_PWRITEV, SYS_PWRITEV2,
    SYS_READ, SYS_READLINKAT, SYS_READV, SYS_RENAMEAT, SYS_RENAMEAT2, SYS_SENDFILE, SYS_SPLICE,
    SYS_STATFS, SYS_STATX, SYS_SYNC, SYS_SYMLINKAT, SYS_TRUNCATE, SYS_UMOUNT2, SYS_UNLINKAT,
