...
pub(crate) fn dispatch(
    ...
    Some(match sysno {
        ...
        SYS_ACCEPT | SYS_ACCEPT4 => ctx.dispatcher.sys_accept(args, ctx.procs, ctx.scheduler, ctx.vfs),
        SYS_CONNECT => ctx.dispatcher.sys_connect(args, ctx.procs, ctx.scheduler, ctx.vfs),
