use crate::{
    DispatchContext, SyscallArgs, SYS_CLOCK_GETRES, SYS_CLOCK_GETTIME, SYS_CLOCK_NANOSLEEP,
    SYS_GETITIMER, SYS_GETTIMEOFDAY, SYS_SETITIMER, SYS_SLEEP, SYS_TIMES,
};
...
pub(crate) fn dispatch(
    ...
    Some(match sysno {
        SYS_SLEEP => ctx.dispatcher.sys_nanosleep(args),
        ...
        SYS_CLOCK_NANOSLEEP => ctx.dispatcher.sys_clock_nanosleep(args),
